...
START TRANSACTION;
USE `tooldepotdb`;
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (1, 4, 'Table Saw', 'This DEWALT offers the ultimate in table saw mobility by pairing a DEWALT 10 in. table saw with a rolling stand. This table saw is designed with a 15 Amp motor that quickly rips through hardwoods with ease. A rack and pinion fence system makes fence adjustments fast, smooth and accurate. The rolling stand is designed for easy set up and break down with excellent stability.', 'Saw', 25, 1, '2017', 'Excellent');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (2, 3, 'Cordless Electric Leaf Blower', 'The M18 FUEL Blower has the power to clear from 15 ft. gets to full throttle in under 1 second, and is up to 4 lbs. lighter than competitors. Designed to meet landscape maintenance professional needs.', 'Yard Equipment', 10, 1, '2015', 'Good');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (3, 4, 'Shop Vac', 'The RIDGID 14 Gal. NXT wet dry vac is more powerful than ever. Best for tackling large-volume messes or heavy-duty pro cleanups. ', 'Large Equipment', 10, 1, '2018', 'Excellent');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (4, 3, 'Cordless Electric Weed Trimmer', 'The RYOBI 40-Volt X Expand-it Trimmer delivers power like a gas trimmer, with none of the hassle of mixing oil and gas. Attachment capability means you can add on RYOBI Expand-It attachments, saving you time, money and space.', 'Yard Equipment', 10, 1, '2018', 'Excellent');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (5, 6, 'Pole Saw', 'ECHO PPF-225 pole saw is lightweight & easy to maneuver. Pole chainsaw\'s 94 in. shaft gives the user maximum reach', 'Saw', 10, 1, '2017', 'Excellent');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (6, 5, 'Gas Weed Trimmer', '30 cc 4-cycle engine is cleaner and produces less noise.  Eliminate the need to mix oil and gas Troy-Bilt\'s 4-cycle engines take regular gas. Quick change cutting head option makes it easy to refill without disassembling the cutting head, simply feed the line through the eyelets and then twist the head to wind the line in seconds\n ', 'Yard Equipment', 5, 1, '2010', 'Poor');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (7, 5, 'Gas Leaf Blower', 'This RYOBI 2 Cycle backpack blower is the most powerful residential backpack blower on the market. The motor delivers a best in class 760 CFM and 175 MPH.', 'Yard Equipment', 5, 1, '2009', 'Good');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (8, 4, 'Corded Electric Leaf Blower', 'Electric blower with 12 Amp Blower/Vac/Mulch with 2 bushel capacity Vac collection bag. Variable speeds of 140 MPH to 240 MPH. Strong enough to vac and mulch everyday lightweight yard waste. ', 'Yard Equipment', 5, 1, '2015', 'Good');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (9, 6, 'Chainsaw', 'The professional-grade ECHO chainsaw CS-310 comes equipped with a 14 in. bar and chain. The rear handle chainsaw is both lightweight and delivers powerful performance. This chainsaw is also packed with features including the side a access chain tensioner for quick chain adjustments and the reduced starting effort feature.', 'Saw', 15, 1, '2012', 'Fair');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (10, 3, 'Air Compressor', '6 Gal. tank allows users to drive a large quantity of nails on a single tank charge. ', 'Large Equipment', 15, 1, '2104', 'Excellent');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (11, 4, 'Pressure Washer', 'This Pressure Washer is engineered to handle even your toughest jobs. With a powerful Honda 187 cc gasoline engine, this RYOBI Pressure Washer delivers 3100 psi of force for quick cleaning of driveways, decks, windows and other areas around the house. Featuring a durable and compact roll-cage frame design this pressure washer is designed for easy transport.', 'Large Equipment', 15, 1, '2013', 'Excellent');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (12, 5, 'Gas Push Lawn Mower', 'This walk-behind lawn mower features a dependable, easy starting 140cc Briggs & Stratton 500e series OHV engine with primer and is equipped with the TriAction cutting system. The TriAction cutting system on this push mower features a rake bumper to lift grass upright, a specially designed blade for a finer mulch and a symmetrical deck for superior grass flow, eliminating clumping.', 'Yard Equipment', 10, 1, '2010', 'Poor');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (13, 3, 'Electric Lawn Mower', 'The EGO 21 Self-Propelled mower with PeakPower technology combines the power of 2 EGO batteries for longer run time and efficient power draw. The push start button provides a quick and easy start, while the self-propel speed control allows you to power through tough terrain at your personal preference. ', 'Yard Equipment', 10, 1, '2016', 'Excellent');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (14, 4, 'Snow Blower', 'Tackle small driveway/walkway jobs in no time with the Toro Power Clear Single-Stage 18 in. Gas Snow Blower with push-of-a-button electric start. Quickly and easily clear 18 in. wide by 12 in. deep snow, and blast compacted snow and ice where you want it up to 25 ft. Ideal for concrete and asphalt surfaces that can park up to 4+ cars and 2 - 9 in. of snow at a time. ', 'Large Equipment', 20, 1, '2015', 'Good');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (15, 5, '22 Foot Ladder', 'This  28 telescoping adjustable heights, this ladder can be used as an Extension Ladder, Double-Sided Twin Stepladder, 90-degree Wall Ladder and a Stairway Stepladder. Easily adjust the height from all sides with one hand with the user-friendly speed locks. The extra-large, heavy-duty MPX hinges give you improved strength with less flex and sway for safer climbing. ', 'Ladder', 10, 1, '2008', 'Good');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (16, 5, '16 Foot Ladder', 'This 16 ft. Aluminum Extension Ladder, offering a 225 lb. load capacity and lightweight aluminum construction. It features slip-resistant, TRACTION-TRED D-rungs and ALFLO rung joints for safe, twist-proof performance. ', 'Ladder', 5, 1, '2005', 'Fair');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (17, 3, 'Shovel', 'This long handle round point shovel is suitable for digging and gardening, particularly in hard, rocky soil. This is a heavy-use tool with a fiberglass handle and tempered steel blade ideal for frequent jobs and yard maintenance. ', 'Hand Tool', 5, 1, '2000', 'Fair');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (18, 5, 'Gas Generator', 'This Portable Generator is a dependable and easy-to-use power source to keep your home prepared for emergencies situations. It produces 9,500 peak watts and 7,500 running watts and features remote start with key fob, Push-Button Electric Start, and backup recoil start.', 'Large Equipment', 25, 1, '2016', 'Excellent');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (19, 5, 'Palm Sander', 'This sander delivers fast, smooth sanding performance with better grip and control. Ideal for woodworkers and finish carpenters, it features controlled pad speed upon startup with a powerful 3 Amp motor for continuous operation. ', 'Power Tool', 10, 1, '2014', 'Good');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (20, 6, 'Socket Wrench Set', 'Set includes (1) 3/8 in. drive 100-position low-profile, long handle ratchet, (1) 3 in. wobble extension bar, (18) Knurl Grip universal sockets: SAE - 1/4, 5/16, 3/8, 7/16, 1/2, 9/16, 5/8, 11/16, 3/4 in. and Metric - 10, 12, 13, 14, 15, 16, 17, 18, 19 mm', 'Hand Tool', 5, 1, '2011', 'Good');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (21, 6, 'Hammer', 'The 16 oz. Claw Hammer features Perm bond construction between its head and handle for strength. It has a comfort cushion Shock Reduction Grip ', 'Hand Tool', 5, 1, '2009', 'Fair');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (22, 3, 'Cordless Power Drill', 'Boasting 19 different clutch positions and an additional high torque setting, you’ll have the versatility and power needed to handle a multitude of projects. Drill wood, metal, plastic and more with torque that measures up to 310 in. lbs. The keyless chuck accepts bits up to 3/8 of an in. in size while the onboard LED light illuminates the work piece during operation. ', 'Power Tool', 10, 1, '2015', 'Good');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (23, 4, 'Corded Power Drill', 'Matrix quick connect system allows for tool-free change of a variety of tool attachments. Powerful 4.0 Amp motor provides enough power for a full range of applications and attachments', 'Power Tool', 10, 1, '2014', 'Good');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (24, 6, 'Reciprocating Saw', 'The DEWALT DWE305 features a powerful 12 Amp motor designed for heavy-duty applications. This reciprocating saw is ideal for cutting wood and nail embedded wood, light to heavy gauge metal, drywall or plaster and plastics, rubber, fiberglass and composites', 'Saw', 10, 1, '2017', 'Great');
INSERT INTO `tool` (`id`, `user_id`, `tool_name`, `description`, `type`, `cost_per_day`, `available`, `manufacture_year`, `condition`) VALUES (25, 5, 'Dehumidifier', '30 pints per day dehumidifier, Hose connection for continous drain option. Easy-roll hidden wheels - Out-of-sight wheels roll easily for bucket emptying\n', 'Large Equipment', 10, 1, '2013', 'Excellent');
